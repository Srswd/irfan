...
export default function Marqueee() {
  return (
    ...
    {/* <p className={styles.imageDescription}>Image 1 Description</p> */}
    </div>
    <div className={styles.postcard}>
    <Image src={mq2} alt='sw3'className={styles.image}/>
    {/* <p className={styles.imageDescription}>Image 2 Description</p> */}
    </div>
    <div className={styles.postcard}>
    <Image src={mq3} alt='sw3'className={styles.image}/>
    {/* <p className={styles.imageDescription}>Image 3 Description</p> */}
    </div>
    <div className={styles.postcard}>
    <Image src={mq4} alt='sw3'className={styles.image}/>
    {/* <p className={styles.imageDescription}>Image 4 Description</p> */}
    </div>
    <div className={styles.postcard}>
    <Image src={mq5} alt='sw3'className={styles.image}/>
    {/* <p className={styles.imageDescription}>Image 5 Description</p> */}
    </div>
    <div className={styles.postcard}>
    <Image src={mq6} alt='sw3'className={styles.image}/>
    {/* <p className={styles.imageDescription}>Image 6 Description</p> */}
    </div><div className={styles.postcard}>
    <Image src={mq7} alt='sw3'className={styles.image}/>
    {/* <p className={styles.imageDescription}>Image 7 Description</p> */}
    </div>
    <div className={styles.postcard}>
    <Image src={mq8} alt='sw3'className={styles.image}/>
    {/* <p className={styles.imageDescription}>Image 8 Description</p> */}
    </div>
    <div className={styles.postcard}>
    <Image src={mq9} alt='sw3'className={styles.image}/>
    {/* <p className={styles.imageDescription}>Image 9 Description</p> */}
    </div>
